    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                {{ __('Invoice Payments Report') }}
            </h2>            
        </div>
    </x-slot>

    <div x-data="{ filterOpen: {{ request()->hasAny(['invoice_number', 'date_from', 'date_to']) ? 'true' : 'false' }} }" class="py-8">
            ...
            <div class="bg-white shadow-sm sm:rounded-lg">
                ...
                <div class="p-6">
                    ...
                    <div class="flex items-center justify-between mb-5">
                        <div>
                            <h3 class="text-lg font-medium text-gray-900">
                                Invoice Payments ({{ $reportData->total() }})
                            </h3>
                        ...
                        <div class="text-right">
                            ...
                            <a href="{{ route('reports.invoicePayments.export', request()->query()) }}"
                            class="inline-flex items-center justify-center
                                    w-9 h-9 rounded-md px-4 py-2
                                    text-gray-600 hover:text-gray-900
                                    hover:bg-gray-100"
                    ...
                    <div x-show="filterOpen"
                        ...
                        <form method="GET" action="{{ route('reports.invoicePayments') }}">
