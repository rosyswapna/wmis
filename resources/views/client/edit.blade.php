                ...
                <div class="p-6">
                    ...
                    <header class="mb-6">
                        ...
                        <p class="mt-1 text-sm text-gray-600">
                            {{ __('Update the client company details.') }}
                        </p>
                    </header>
                            ...
                            <div>
                                ...
                                >
                                    ...
                                    @foreach ($countries as $country)
                                        <option
                                            value="{{ $country->id }}"
                                            @selected(old('country_id', $client->country_id) == $country->id)
                                        >
                                            {{ $country->name }}
                                        </option>
                                    @endforeach
                            ...
                            <div>
                                ...
                                >
                                    ...
                                    @foreach ($states as $state)
                                        <option
                                            value="{{ $state->id }}"
                                            @selected(old('state_id', $client->state_id) == $state->id)
                                        >
                                            {{ $state->name }}
                                        </option>
                                    @endforeach
                            ...
                            <div>
                                ...
                                >
                                    ...
                                    @foreach ($cities as $city)
                                        <option
                                            value="{{ $city->id }}"
                                            @selected(old('city_id', $client->city_id) == $city->id)
                                        >
                                            {{ $city->name }}
                                        </option>
                                    @endforeach
